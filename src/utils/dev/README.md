Скрипт ищет все файлы с расширением `.md` в указанном каталоге и его подкаталогах, отделяет front-matter от контента и сохранять их по отдельности в файлы с расширением .json и .md в указанный
выходной каталог.
